...
class AuthService:
    ...
    def logout(self, *, refresh_token: str | None, user_id: UUID | None = None) -> None:
        ...
        self.repository.add_audit_log(action='LOGOUT', user_id=user_id)
        self.db.commit()
    ...
    def request_password_reset(self, *, email: str) -> None:
        ...
        if user and user.is_active:
            ...
            self.repository.add_audit_log(action='PASSWORD_RESET_REQUESTED', user_id=user.id)
            self.db.commit()
    ...
    def reset_password(self, *, token: str, new_password: str) -> None:
        ...
        self.repository.add_audit_log(action='PASSWORD_RESET_COMPLETED', user_id=user.id)
        self.db.commit()
