      ...
      <main className="management-page">
        ...
        <form className="analytics-filter-bar" onSubmit={submit}>
          ...
          <div className="analytics-filter-actions">
            <button className={`primary-button compact action-button ${editing ? 'action-save' : 'action-create'}`} type="submit">{editing ? 'Save' : 'Create'}</button>
            {editing ? <button className="secondary-button compact action-button action-clear" type="button" onClick={() => { setEditing(''); setForm(EMPTY_FORM) }}>Cancel</button> : null}
          </div>
        </form>
